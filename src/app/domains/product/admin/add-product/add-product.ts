...
import { IProductFormDtoWrapper, IProductSupplier } from '../../data/models/product.model';
...
export class AddProduct {
  ...
  private fetchDefaultForm() {
    this.productService
      .fetchDefaultForm(this.idsSignal().patientId)
      .pipe(takeUntilDestroyed(this.destroy$))
      .subscribe((res: IProductFormDtoWrapper) => {
        console.log('res:', res);
    ...
    this.productService
      ...
      .subscribe({
        next: (res: ICustomResponse) => {
          ...
          this.form.reset();
          this.router.navigate(['auth/list-product']);
        },
      });
  }
